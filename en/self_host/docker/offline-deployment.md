...
After installation, access SwanLab at `http://localhost:8000` (default port: 8000). Follow the [activation guide](/en/self_host/docker/deploy#_3-activate-the-primary-account) for the first login.
