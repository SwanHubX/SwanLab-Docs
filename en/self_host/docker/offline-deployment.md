...
After installation, access SwanLab at `http://localhost:8000` (default port: 8000). Follow the [activation guide](./deploy.md#_3-activate-the-primary-account) for the first login.
