...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/01.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/02.png)

Our training task aims to enable the trained SD model to generate Naruto-style images based on input prompts:

![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/03.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/04.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/06.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/07.png)

Let's take a look at the subjectively generated images. The images from the first epoch look like this:

![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/08.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/09.png)

![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/10.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/images/stable_diffusion/11.png)
