...
![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/05.png)
![Left image as train.csv, right image as the image in the cat folder in the train folder](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/06.png)
...
![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/08.png)

Then, we run `train.py`:

![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/09.png)
...
![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/10.png)
...
![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/11.png)
...
![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/12.png)
...
![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/14.png)
Open the link to see the cat and dog classification demo webpage:

![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/15.png)

Try it with cat and dog images:

![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/16.png)

![Insert image description here](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/cats_dogs/17.png)
