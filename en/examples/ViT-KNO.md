...
For MindSpore installation, refer to [Ascend NPU & MindSpore | SwanLab](../guide_cloud/integration/integration-ascend.md#install-mindspore).
...
- **Loss Curve**: Monitoring model convergence.
  ...
  ![loss](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/ViT-KNO/loss.png)

- **Run Logs**: Detailed output information.

  ![log](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/ViT-KNO/log.png)
...
![swanlab_terminal](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/ViT-KNO/swanlab_terminal.png)

After opening the dashboard, you can view all visualization results generated during inference on the "Charts" page:

![plt](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/ViT-KNO/plt.png)

![img1](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/ViT-KNO/img1.png)
...
![multi_img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/examples/ViT-KNO/multi_img.png)
...
- SwanLab: [SwanLab](../guide_cloud/general/what-is-swanlab.md)
