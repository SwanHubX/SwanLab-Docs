...
`swanlab.OpenApi` has been **removed** in version `≥ 0.8.0`.Please migrate to the new [`swanlab.Api`](./py-api.md) instead.
...
![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/api/py-openapi/exp_id.png)
