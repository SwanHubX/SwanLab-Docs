...
![slack-logo](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/plugin/notification-slack/logo.jpg)
...
<img src="https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/plugin/notification-slack/from-scratch.png" width="400"/>

3. Input **「App Name」** ，and select the workspace you want to send notification，then click **「Create App」**

<img src="https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/plugin/notification-slack/name-app.png" width="400"/>

4. Once into the App configuration menu，click **「Incoming Webhooks」**，and turn on the button **「Activate Incoming Webhooks」** ；

<img src="https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/plugin/notification-slack/slack-webhook-option.png" width="400"/>
...
<img src="https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/plugin/notification-slack/allow-channel.png" width="400"/>
