...
- 🔥 Added HTML chart support, allowing embedding of pages generated by LLM Vibe Coding. See [swanlab.Html()](https://docs.swanlab.cn/en/api/py-html.html)
- 🧭 Kubernetes deployment Prometheus + Grafana solution is now available. See [Monitoring & Logging Configuration Guide](https://docs.swanlab.cn/en/self_host/kubernetes/monitor-logging.html)
