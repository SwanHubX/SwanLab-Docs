...
- 🔥 Added HTML chart support, allowing embedding of pages generated by LLM Vibe Coding. See [swanlab.Html()](../../api/py-html.md)
- 🧭 Kubernetes deployment Prometheus + Grafana solution is now available. See [Monitoring & Logging Configuration Guide](../../self_host/kubernetes/monitor-logging.md)
...
Released SwanLab Kubernetes version, deployment instructions see [this document](../../self_host/kubernetes/deploy.md)
...
- Added integration with NVIDIA-NeMo RL framework, [Documentation](../integration/integration-nvidia-nemo-rl.md)
- Added integration with Telegram notification plugin, [Documentation](../../plugin/notification-telegram.md)
...
- Added Bark notification plugin, supporting iOS push notifications when training completes or an error occurs, [Documentation](../../plugin/notification-bark.md)
...
- Added `swanlab local`, `swanlab online`, `swanlab offline`, `swanlab disabled` commands to quickly set SwanLab mode in the command line, [Documentation](../../api/cli-swanlab-offline.md)

## v0.6.9 - 2025.09.09

**🚀 New Features**

- Projects now support adding collaborators. [Documentation](../experiment_track/add-collaborator.md)
...
- Added integration with Apple's [MLX LM](https://github.com/ml-explore/mlx-lm) framework. [Documentation](../integration/integration-mlx-lm.md)
...
- [swanlab sync](../experiment_track/sync-logfile.md) now offers improved compatibility for log file integrity, adapting to scenarios such as training crashes
- New chart types released: [PR Curve](../../api/py-pr_curve.md), [ROC Curve](../../api/py-roc_curve.md), and [Confusion Matrix](../../api/py-confusion_matrix.md)
...
- 🤗 Integrated with the [accelerate](https://github.com/huggingface/accelerate) framework. See the [documentation](../integration/integration-huggingface-accelerate.md) to enhance experiment tracking in distributed training.
- Integrated with the [ROLL](https://github.com/alibaba/ROLL) framework. See the [documentation](../integration/integration-roll.md) to improve experiment logging during distributed training.
- Integrated with the [Ray](https://github.com/ray-project/ray) framework. See the [documentation](../integration/integration-ray.md) to enhance experiment tracking in distributed training environments.
...
* Added `swanlab.Object3D` to support recording 3D point clouds. [Docs](../../api/py-object3d.md)
...
- Introduced `swanlab.register_callback()`, enabling the registration of callback functions outside of `init`. [Documentation](../../api/py-register-callback.md)
- Upgraded `swanlab.login()` with new parameters `host`, `web_host`, and `save`, adapting to the characteristics of self-hosted deployment services and supporting the option to not write user login credentials locally for shared server scenarios. [Documentation](../../api/py-login.md)
- Upgraded `swanlab login` with new parameters `host`, `web_host`, and `api-key`. [Documentation](../../api/cli-swanlab-login.md)
- Added support for using `swanlab.sync_mlflow()` to synchronize MLflow projects to SwanLab. [Documentation](../integration/integration-mlflow.md)
...
• Added integration with [DiffSynth-Studio](https://github.com/modelscope/DiffSynth-Studio), [Documentation](../integration/integration-diffsynth-studio.md).  
• Added support for converting **MLflow** experiments to SwanLab. [Documentation](../integration/integration-mlflow.md).  
...
- Added integration with ModelScope Swift, [Docs](../integration/integration-swift.md)
...
- Added integration with LLM reinforcement learning framework [verl](https://github.com/volcengine/verl), [Docs](../integration/integration-verl.md)
...
- Added `swanlab.sync_tensorboardX()` and `swanlab.sync_tensorboard_torch()`: Supports synchronizing metrics to SwanLab when using TensorBoardX or PyTorch.utils.tensorboard for experiment tracking. [Docs](../integration/integration-tensorboard.md)
...
- Added `swanlab.sync_wandb()`: Supports synchronizing metrics to SwanLab when using Weights & Biases for experiment tracking. [Docs](../integration/integration-wandb.md)
