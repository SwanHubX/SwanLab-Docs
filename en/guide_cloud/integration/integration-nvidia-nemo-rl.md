...
![1-Header-NVIDIA-SwanLab](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/01.png)
...
![3-NeMo-Framework-Architecture](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/03.png)
...
![4-GitHub-News](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/04.png)
...
![5-GRPO-Training-Charts](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/05.png)

GPU memory usage is shown below (using 8x RTX 5090 GPUs):

![6-GRPO-Memory-Usage](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/06.png)
...
![7-YAML-Config-Screenshot](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/07.png)
...
![8-SFT-Training-Charts](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/08.png)

GPU memory usage is shown below (using 8x RTX 5090 GPUs):

![9-SFT-Memory-Usage](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/integration/nvidia_nemo_rl/09.png)
