...
![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/experiment_track/faq/smooth_setting.png)

In the menu pulled out on the right, find the "Smooth" option and slide the slider to enable smoothing:

![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/experiment_track/faq/smooth_button.png)

## How to Change an Experiment's 'Crashed' Status

On the experiment page, click the status label:

![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/experiment_track/faq/exp_header_crash.png)

In the pop-up window, select your desired status:

![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/experiment_track/faq/exp_windows_finish.png)
