...
swanlab.init(
    ...
    workspace="<workspace>",
    resume=True,
    id="<exp_id>",  # Supports 1–64 custom characters
)
```
...
The **experiment ID** is the unique identifier for an experiment. It can be found in the "Environment" tab of the experiment or in the URL. It supports 1–64 custom characters (characters `/ \ # ? % :` are not allowed):

![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/en/guide_cloud/experiment_track/resume-experiment/exp_id.png)
