  ...
  <div class="blog-page">
    ...
    <div class="blog-header">
      ...
      <div class="blog-header-content">
        <h1 class="blog-title">SwanLab Blog</h1>
        <p class="blog-subtitle">Explore the latest updates, tutorials, and best practices in machine learning experiment tracking</p>
      </div>
    </div>
