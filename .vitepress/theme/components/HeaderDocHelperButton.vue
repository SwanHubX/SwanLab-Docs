...
<template>
  <a
    class="vp-header-doc-helper-btn"
    href="https://chat.swanlab.cn"
    target="_blank"
    rel="noopener"
    aria-label="AI文档助手"
  >
...
.vp-header-doc-helper-btn .doc-helper-logo {
  width: 18px;
  height: 18px;
  margin-right: 8px;
