...
export const en = defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      "/en/guide_cloud/integration/": {
        base: "/en/guide_cloud/integration/",
  ...
  return [
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Log Confusion Matrix",
              link: "experiment_track/compute_metric/log-confusion-matrix",
            },
          ],
        },
        { text: "Smooth line plots", link: "experiment_track/smooth-algorithms" },
        {
          text: "Log distributed training metric",
    ...
    },
    {
      ...
      items: [
        ...
        {
          text: "Access SwanLab on internal computing nodes",
          link: "experiment_track/ssh-portforwarding",
        },
...
function sidebarExamples(): DefaultTheme.SidebarItem[] {
  return [
    ...
    {
      text: "Robot",
      items: [{ text: "LeRobot Guide", link: "robot/lerobot-guide" }],
    },
    {
    ...
    },
    {
      text: "Audio",
      // collapsed: false,
      items: [{ text: "Audio Classification", link: "audio_classification" }],
    },
    {
      text: "Time Series",
      // collapsed: false,
...
function sidebarPlugin(): DefaultTheme.SidebarItem[] {
  return [
    ...
    },
    {
      text: "📝 Writer",
      // collapsed: false,
      items: [{ text: "CSV Table", link: "writer-csv" }],
    },
  ];
}
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            {
              text: "Migration from Docker to Kubernetes",
              link: "docker/migration-docker-kubernetes",
            },
