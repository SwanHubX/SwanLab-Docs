  ...
  return [
    {
      ...
      items: [
        ...
        { text: '🔥手机看实验', link: 'general/app', badge: { type: 'hot', text: 'HOT' } },
      ]
    },
    {
      text: '📚 实验跟踪',
      // collapsed: false,
      items: [
        { text: '什么是实验跟踪', link: 'experiment_track/what-is-experiment-track', badge: { type: 'new', text: 'NEW' } },
        ...
        { text: '记录指标', link: 'experiment_track/log-experiment-metric' },
        {
          text: '记录多维数据', items: [
            ...
            { text: '自定义3D图表', link: 'experiment_track/log-custom-3dchart', badge: { type: 'beta', text: 'BETA' } },
          ]
        },
        {
        ...
        { text: '分享项目', link: 'experiment_track/share-project' },
        { text: '技巧', items: [
