...
export const zh = defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
        ...
        items: [
          { text: "全部40+框架", link: base_path_guide_cloud + "/integration" },
          {
            ...
            items: [
              ...
              {
                text: "Lightning",
                link: base_path_guide_cloud + "/integration/integration-pytorch-lightning",
              },
              {
                text: "LLaMA-Factory",
                link: base_path_guide_cloud + "/integration/integration-llama-factory",
              },
              ...
              {
                text: "Ultralytics",
                link: base_path_guide_cloud + "/integration/integration-ultralytics",
              },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "建议反馈",
            link: "https://geektechstudio.feishu.cn/share/base/form/shrcn8koDFRcH2mMcBYMh9tiKfI",
          },
          {
            text: "加入我们",
            link: "https://rcnpx636fedp.feishu.cn/wiki/BxtVwAc0siV0xrkCbPTcldBEnNP",
          },
    ...
    sidebar: {
      ...
      "/guide_cloud/integration/": {
        base: "/guide_cloud/integration/",
        items: sidebarIntegration(),
      },
      "/api/": { base: "/api/", items: sidebarAPI() },
      "/plugin/": { base: "/plugin/", items: sidebarPlugin() },
      "/self_host/": { base: "/self_host/", items: sidebarSelfHosted() },
      "/course/prompt_engineering_course/": {
        base: "/course/prompt_engineering_course/",
        items: sidebarCoursePromptEngineering(),
      },
      "/course/llm_train_course/": {
        base: "/course/llm_train_course/",
        items: sidebarCourseLLMTrain(),
      },
    },
...
function sidebarExamples(): DefaultTheme.SidebarItem[] {
  return [
    ...
    {
      text: "机器人",
      items: [{ text: "LeRobot 入门", link: "robot/lerobot-guide" }],
    },
    {
      text: "强化学习",
      // collapsed: false,
...
function sidebarPlugin(): DefaultTheme.SidebarItem[] {
  return [
    ...
    },
    {
      text: "📝 记录类",
      // collapsed: false,
      items: [{ text: "CSV表格", link: "writer-csv" }],
    },
  ];
}
  ...
  return [
    {
      ...
      items: [
        ...
        {
          text: "第一章 环境安装",
          link: "03-environmental_installation_platform_preparation/README.md",
        },
        { text: "第二章 模型选择", link: "04-model_types/README.md" },
        {
          text: "第三章 提示词撰写技巧",
          link: "05-tips_for_prompt/README.md",
          items: [
        ...
        {
          text: "第六章 合成数据",
          link: "08-synthetic_data/README.md",
          items: [
  ...
  return [
    {
      ...
      items: [
        ...
        {
          text: "第二章 预训练",
          items: [{ text: "2.1 LLM预训练", link: "02-pretrain/1.qwen-pretrain/README.md" }],
        },
        {
          text: "第三章 微调",
          items: [
        ...
        {
          text: "第五章 评估",
          items: [{ text: "5.1 EvalScope使用", link: "05-eval/1.evalscope/README.md" }],
        },
        {
          text: "第六章 视觉大模型",
          items: [
            { text: "6.1 Qwen2-VL微调", link: "06-multillm/1.qwen_vl_coco/README.md" },
            {
              ...
              link: "06-multillm/2.qwen3_smolvlm_muxi/README.md",
            },
        ...
        {
          text: "第八章 扩散模型",
          items: [{ text: "8.1 LLaDA模型预训练和微调", link: "08-diffusion/1.llada/README.md" }],
        },
      ],
    },
  ];
