...
...
 ...
 Self-Hosted Docker v2.8.1 - @SwanLab
...
swanlab-cloud        ccr.ccs.tencentyun.com/self-hosted/swanlab-cloud:v2.8.1                   "/docker-entrypoint.…"   swanlab-cloud    22 minutes ago   Up 21 minutes             80/tcp
...
swanlab-house        ccr.ccs.tencentyun.com/self-hosted/swanlab-house:v2.8.1                   "./app"                  swanlab-house    22 minutes ago   Up 21 minutes (healthy)   3000/tcp
...
swanlab-next         ccr.ccs.tencentyun.com/self-hosted/swanlab-next:v2.8.1                    "docker-entrypoint.s…"   swanlab-next     22 minutes ago   Up 21 minutes             3000/tcp
...
swanlab-server       ccr.ccs.tencentyun.com/self-hosted/swanlab-server:v2.8.1                  "docker-entrypoint.s…"   swanlab-server   22 minutes ago   Up 21 minutes (healthy)   3000/tcp
...
安装成功后，可以通过 `http://localhost:8000` （默认端口为8000）直接打开网站。第一次打开需要激活主账户，流程见[文档](https://docs.swanlab.cn/self_host/docker-deploy.html#_3-%E6%BF%80%E6%B4%BB%E4%B8%BB%E8%B4%A6%E5%8F%B7)。
