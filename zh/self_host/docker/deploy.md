# 使用Docker进行部署 <img src="/docker.svg" class="deploy-logo" alt="Docker" /> <VersionBadge version="v3.4.0" />
...
> <img src="https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/self_host/docker-deploy/wsl-dockerinfo.png" width="600"/>

> 在WSL2的文件系统中执行 `.sh` 安装脚本
> <img src="https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/self_host/docker-deploy/wsl-bash.png" width="600"/>
...
在私有化部署 > `v2.8.0`的版本中，支持在离线环境下验证License。
...
![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/self_host/docker-deploy/test-experiment.png)
...
![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/self_host/docker-deploy/upgrade.png)
