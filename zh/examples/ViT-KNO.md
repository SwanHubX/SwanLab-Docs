...
对于Mindspore的安装可参考 [Ascend NPU & MindSpore | SwanLab官方文档](../guide_cloud/integration/integration-ascend.md#安装mindspore) 。
...
- **Loss 曲线**：监控模型收敛情况
  ...
  ![loss](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/loss.png)

- **运行日志**：详细输出信息

  ![log](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/log.png)

- **实验总览**：全面展示模型信息

  ![overview](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/overview.png)
...
![swanlab_terminal](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/swanlab_terminal.png)

打开仪表盘后，可在“图表”页面查看推理过程中生成的所有可视化结果：

![plt](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/plt.png)

![img1](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/img1.png)
...
![multi_img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/multi_img.png)

![img2](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/ViT-KNO/img2.png)
...
- SwanLab使用：[欢迎使用SwanLab | SwanLab官方文档](../guide_cloud/general/what-is-swanlab.md)
