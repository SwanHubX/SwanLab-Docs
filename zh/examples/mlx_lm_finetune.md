...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/apple-intelligence.png)

本篇教程将带大家了解下如何Macbook来进行Qwen3微调，并且利用苹果自家发的MLX深度学习框架，让Macbook的性能发挥到极致。

## MLX框架简介

![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/mlx.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/mlx-swanlab.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/dataset.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/qwen3.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/train.png)

如果开启了SwanLab跟踪，则会自动记录训练损失图像。可以看到大概500步模型训练损失就收敛了

![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/log.png)

实验记录已公开：<https://swanlab.cn/@ShaohonChen/MLX-FT-Qwen3/charts>

训练速度非常快，在笔者的轻薄本上不到2分钟就完成了训练，使用了不到2G内存，吞吐快400Token/S。

![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/runtime.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/chat.png)

英文聊天也不在话下！

![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/eng_chat.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/infer_test.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/infer_lab.png)

![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/mlx_lm_finetune/infer_system.png)
