...
[![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/badge1.svg)](https://swanlab.cn/@ZeyiLin/SD-Naruto/runs/21flglg1lbnqo67a6f1kr/chart)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/01.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/02.png)


我们的训练任务，便是希望训练后的SD模型能够输入提示词，生成火影风格的图像：

![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/03.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/04.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/05.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/06.png)


可以看到SD训练的特点是loss一直在震荡，随着epoch的增加，loss在最初下降后，后续的变化其实并不大：

![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/07.png)


我们来看看主观生成的图像，第一个epoch的图像长这样：

![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/08.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/09.png)


![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/10.png)
...
![alt text](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/examples/images/stable_diffusion/11.png)
