...
| 环境变量            | 描述                                                                                                                        | 默认值                           |
| ------------------- | --------------------------------------------------------------------------------------------------------------------------- | -------------------------------- |
| `SWANLAB_SAVE_DIR`  | SwanLab 全局文件夹保存的路径（已废弃，推荐使用 [`SWANLAB_ROOT`](#根目录配置)）                                               | 用户主目录下的 `.swanlab` 文件夹 |
...
| `SWANLAB_RUN_DIR`       | 自定义运行文件夹名称，设置后将跳过目录冲突重试                                                                  | 自动生成                       |
| `SWANLAB_RUN_DIR_MAX_LENGTH` | 自动生成的运行文件夹名称的最大长度                                                                              | `255`                          |
