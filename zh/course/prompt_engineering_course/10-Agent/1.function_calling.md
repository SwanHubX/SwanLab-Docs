...
<div style="display:flex;justify-content:center;">
  <figure style="text-align:center;margin:0;">
    <img src="https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/course/prompt_engineering_course/10-Agent/picture/function_calling_theory.png" style="width:700px;" alt="函数调用原理">
