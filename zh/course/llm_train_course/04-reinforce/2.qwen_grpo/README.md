...
[![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/badge1.svg)](https://swanlab.cn/@LiXinYu/Try_r1/overview)

## 简介
本文旨在对deepseek-r1-zero进行复现实验，简单介绍了从r1原理到代码实现，再到结果观测的整个过程。通过SwanLab监控实验过程，确保实验的每个阶段都能精确跟踪与调试。通过这一系列的实验步骤，能够掌握GRPO的实现方法。

![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/course/llm_train_course/04-reinforce/2.qwen_grpo/grpo/r1-zero-ds-qwen.jpg)
...
![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/course/llm_train_course/04-reinforce/2.qwen_grpo/grpo/deepseek-r1-process.png)
...
![grpo](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/course/llm_train_course/04-reinforce/2.qwen_grpo/grpo/grpo.png)
...
![数据集内容](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/course/llm_train_course/04-reinforce/2.qwen_grpo/grpo/data-countdown.png)
...
![swanlab观测结果](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/course/llm_train_course/04-reinforce/2.qwen_grpo/grpo/swanlab-results.png)
