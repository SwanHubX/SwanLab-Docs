...
![SwanLab标志与Jupyter标志通过爱心连接](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/experiment_track/jupyter-notebook/swanlab-love-jupyter.jpg)
...
![Jupyter notebook中执行swanlab.init()后的输出界面，底部显示'Display SwanLab Dashboard'按钮，用于打开SwanLab实验仪表板。](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/jupyter-notebook-1.jpg)

点击该按钮，就会在Notebook中嵌入该实验的SwanLab网页：

![Jupyter notebook 中嵌入了 SwanLab 实验仪表板，用于显示实验详情、元数据和导航界面。](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/jupyter-notebook-2.jpg)
