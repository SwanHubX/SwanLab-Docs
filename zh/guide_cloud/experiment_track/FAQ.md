...
这是因为SwanLab判定中断有一条隐藏规则，如果训练进程在30分钟以内没有任何日志上传（包含自动收集的系统指标），则判定为中断，这是为了避免训练进程被意外Kill后，无法触达SwanLab SDK中的状态上传逻辑，导致实验永远处于“运行中”状态。

所以如果你的机器出现了网络问题，且时间大于30分钟，就会导致实验状态显示为“中断”。
...
![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/experiment_track/faq/smooth_setting.png)
...
![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/experiment_track/faq/exp_header_crash.png)
...
参考文档：[resume](./resume-experiment.md)
