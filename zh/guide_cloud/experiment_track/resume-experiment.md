...
`实验id`是实验的唯一标识，可以在实验的「环境」选项卡或URL中找到，支持1-64位自定义字符（不可含有 `/ \ # ? % :` 等特殊字符）：

![](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/experiment_track/resume-experiment/exp_id.png)
