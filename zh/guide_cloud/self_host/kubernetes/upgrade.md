...
2. **确认镜像仓库可达**：您需要保证集群可以访问 `repo.swanlab.cn`，以保证能够正常拉取镜像 （否则您需要将已知的镜像拉取下来推送到私有仓库）。详见[SwanLab 私有化版用到了哪些镜像？](/guide_cloud/self_host/kubernetes/faq#【镜像类】swanlab-私有化版用到了哪些镜像)。
...
> ⚠️ 注意：https://helm.swanlab.cn 的 chart 包在 GitHub Release 页面做索引 https://github.com/SwanHubX/charts/releases ， 请提前确认连通性
