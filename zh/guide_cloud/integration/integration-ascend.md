...
![device](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/integration/ascend/device_mask.png)
...
![data_image](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/integration/ascend/data_image.png)
...
![lstm](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/integration/ascend/lstm.png)
...
![npu-smi](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/integration/ascend/a_mask.png)
...
![condainstallfailed](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/integration/ascend/b.png)
...
> 如果提示登录swanlab，可以参考[如何登录SwanLab](../general/quick-start.md#_2-%E7%99%BB%E5%BD%95%E8%B4%A6%E5%8F%B7)，这样将能够使用**云上看版**随时查看训练过程与结果。

完成设置便可以在云上实时看到训练进展，我的实验记录可参考[完整实验记录](https://swanlab.cn/@ShaohonChen/Ascend_IMDB_CLS/charts)

![log_img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/integration/ascend/log_img.png)
...
![log_table](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/integration/ascend/log_table.png)
