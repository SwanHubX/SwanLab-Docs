...
![1-Header-NVIDIA-SwanLab](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/01.png)
...
![3-NeMo-Framework-Architecture](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/03.png)
...
![4-GitHub-News](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/04.png)
...
![5-GRPO-Training-Charts](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/05.png)

显存使用情况如下图所示（显卡为 8 卡 RTX 5090）：

![6-GRPO-Memory-Usage](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/06.png)

如果你希望配置更多参数，可以在 `examples/configs/grpo_math_1B.yaml` 里进行编辑。

如果你希望设置 SwanLab 的项目名与实验名，在 yaml 文件中找到：

![7-YAML-Config-Screenshot](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/07.png)
...
![8-SFT-Training-Charts](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/08.png)

显存使用情况如下图所示（显卡为 8 卡 RTX 5090）：

![9-SFT-Memory-Usage](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/zh/guide_cloud/integration/nvidia_nemo_rl/09.png)
