...
2. **安装 VSCode 插件（可选）**
   ...
   ![vscode-recommend](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/community/contributing-code/vscode_recommend.png)
...
![img](https://swanlab-docs-1301372061.cos.ap-beijing.myqcloud.com/assets/assets/guide_cloud/community/contributing-code/debug.png)
